        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>Como <strong>Administrador</strong> puedes <em>Asignar</em> y <em>Eliminar</em> permisos de los usuarios.</p>
<p>Como <strong>Administrador</strong> puedes <em>Ver</em>, <em>Agregar</em>, <em>Editar</em> y <em>Eliminar</em> a un Estudiante.</p>
<p>Como <strong>Docente</strong> puedes <em>Ver</em>, <em>Agregar</em> y <em>Editar</em> a un Estudiante.</p>
<p>Como <strong>Director</strong> puedes <em>Ver</em> la lista de Estudiantes.</p>
                                ...
                                @if (Auth::user()->hasRole('admin'))
                                    ...
                                    <td>
                                        @if ($firstAdmin && $firstAdmin->id === $user->id)
                                            <span>No se puede modificar el rol de este administrador.</span>
                                        @else
